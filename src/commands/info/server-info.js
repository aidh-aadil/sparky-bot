        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    {name: 'Channels and categories', value: `${interaction.guild.channels.cache.size}`, inline: true},
                    {name: 'Boosts', value: `${interaction.guild.premiumSubscriptionCount}`, inline: true},
                    {name: 'Image scan', value: `${getExplicitContentFilterLevel(interaction.guild.explicitContentFilter)}`, inline: true},
                    {name: 'Verification lvl', value:`${getVerificationLevel(interaction.guild.verificationLevel)}`, inline: true}
                )
