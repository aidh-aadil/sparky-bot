    ...
    callback: async (client, interaction) => {
        try {
            ...
            if(targetUser.id === interaction.guild.ownerId) {
                await interaction.editReply(`You are not allowed to warn that user. They are the server owner`)
                return
            }
            ...
            if(targetUserRolePosition >= requestUserRolePosition) {
                await interaction.editReply('You cannot warn someone higher than or equal to you.')
                return
            }

            if(targetUserRolePosition >= botRolePosition) {
                await interaction.editReply('I cannot warn someone higher than or equal to me.')
                return
            }
